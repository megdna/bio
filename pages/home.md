...
<ul style="list-style-type:none; padding-left:0.5rem">
  <li>→ <a href="{{ site.baseurl }}/about">Learn More</a></li>
  <li>→ <a href="{{ site.baseurl }}/contact">Get Involved</a></li>
  <li>→ <a href="{{ site.baseurl }}/posts">View Projects</a></li>
</ul>
...
<ul style="list-style-type:none; padding-left:0.5rem">
  ...
  <li>{% octicon rss class:"icon" height:16 %} <a href="{{ site.baseurl }}/feed" target="_blank" data-goatcounter-click="subscribe">Subscribe to feed</a></li>
</ul>