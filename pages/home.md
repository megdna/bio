...
<ul style="list-style-type:none">
  ...
  <li>→ <a href="{{ site.url }}/contact">Get Involved</a></li>
  <li>→ <a href="{{ site.url }}/posts">View Projects</a></li>
</ul>
...
<ul style="list-style-type:none">
  ...
  <li>{% octicon rss class:"icon" height:16 %} <a href="{{ site.url }}/feed" target="_blank" data-goatcounter-click="subscribe">Subscribe to feed</a></li>
</ul>